...
public class Server {
    ...
    private static ServerSocket createServerSocket() throws IOException {
        ...
        // 绑定之后未进入accept queue,既在上次握手中client发了syn后进入server的syn列队中(半连接),这里设置列队长度50
    ...
    private static void initServerSocket(ServerSocket serverSocket) throws IOException {
        ...
        // 设置性能参数：短链接，延迟，带宽的相对重要性(设置的是权重)
        // 短连接:很快关闭
        // 延迟:延迟越大,就越不敏捷,多包合并发送,有效利用带宽
        // n带宽利用,越大延迟越大,越小延迟较低
...
//                System.out.println("收到数量：" + (readCount+readCount1) + " 数据："
//                        + be + "\n"
//                        + c + "\n"
//                        + i + "\n"
//                        + b + "\n"
